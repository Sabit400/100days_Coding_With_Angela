...
if choice1 == "right":
    choice2 = input('You\'ve come to a lake. There is an island in the middle of the lake. Type "wait" to wait for a bot. Type "swim" to swim across. \n').lower()
    if choice2 == "wait":
        ...
        if choice3 == "red":
            ...
            print("There are two pythons, Game over! ")
        else:
